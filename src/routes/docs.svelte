...
<svelte:head>
  ...
  <meta
    name="description"
    content="News and updates related to the Neil Rogers audio restoration
    project." />
  <Meta />
</svelte:head>
...
<p>
  <a
    href="https://medium.com/@CriticalMAS/miami-herald-covers-the-neil-rogers-audio-recovery-project-neil-rogers-3ab76861ceed">
    Miami Herald Covers the Neil Rogers Audio Recovery Project
  </a>
</p>
<p>
  <a
    href="https://medium.com/@CriticalMAS/neil-rogers-2016-radio-hall-of-fame-induction-neil-rogers-5dd2906f7bf9">
    Neil Rogers 2016 Radio Hall of Fame Induction
  </a>
</p>
<p>
  <a
    href="https://medium.com/@CriticalMAS/interview-with-radio-ink-january-2014-neil-rogers-b43bfbb83786">
...
<h3>Other</h3>
<p>
  <b>Cranker's Courier</b>
  - In the mid 1980s a young man, while still in high school, began sending out
...
<p>
  Do you have any audio of the Neil Rogers Show or other South Florida talk
  radio shows that you would like to share? Check our archives to see if we have
  a show from that date. If the show is before 1999 and it already exists in our
  archive, we may still able to use your audio. Most of the shows before 1999
  are partial. Some are good quality and some aren’t. We can date the show and
  add to the archive.
</p>
<p>
  Ideally, your audio should be in digital format. Since John Baker passed away,
  we are no longer set up to convert tapes to digital.
</p>
...
<p>
  Our goal is to not only collect as much audio as possible but to index all the
  shows and make the topics searchable. Many of the shows from 2001-2009 do not
  have notes. Our goal is to have notes for every recovered show. This will make
  it easier for Neil fans to find the shows they are looking for.
</p>
...
<ol>
  ...
  <li>
    Those notes will either be pinned (as top comment) and/or added to the show
    description.
  </li>
</ol>
...
<p>
  Spread the word to others about Uncle Neil by sharing links to everything we
  have saved. Give a like to the shows. The more fans that discover Neil is
  alive and well in the archives, the more likely we will find the fans that
  have more audio to add to our collection.
</p>

<h4>#4 Do You Know Someone That Works For Yahoo!?</h4>
<p>
  In 1999 Yahoo! acquired Broadcast.com, which archived the Neil Rogers Show in
  the early days. We need many of the shows from December 30, 1997, to January
  19, 1999. They will be in Real Audio format. Below is a list of URLs that
  might be clues as to what servers or backup archives these audio files might
  be found.{' '}
...
<p>
  ...
  archives. I am absolutely convinced these shows exist somewhere on a Yahoo!
  server that the public does not have access to.
</p>

<hr />
<h3>Privacy Policy</h3>
<p>
  The 2020 rewrite of NeilRogers.org does not use any cookies or collect any
  user data.
</p>
