...
<svelte:head>
  ...
  <meta
    name="description"
    href="A history of the life of radio legend Neil Rogers." />
  <Meta />
</svelte:head>
...
<h3>Childhood</h3>
<p>
  Neil Rogers (Nelson Roger Behelfer) was born at Strong Memorial Hospital in
  Rochester, New York on November 5, 1942.
</p>

<p>
  Neil’s first childhood home was on Ok Terrace in Rochester. He attended
  Brighton Elementary School. He later moved to 74 Fort Hill Ave in Canandaigua
  New York. Neil won a National Merit Scholarship at Canandaigua Academy in
  1959.
</p>

<figure>
  <Image
    src="images/neil_1959.jpg"
...
<p>
  Neil’s first radio job was while he was still in high school. At age 17 he
  played music on WCGR in Canandaigua, NY. Then he attended college for two
  years at Michigan State where he studied broadcasting. After Michigan State,
  Neil returned to New York in 1963 where he worked for WBTA 1490 in Batavia,
  NY.
</p>
...
<ul>
  ...
  <li>Kalamazoo, MI (WTPS) – General Manager, Program Director, Morning DJ</li>
  <li>Detroit – Took a job selling advertising on radio.</li>
  <li>Lansing – (station unknown)</li>
</ul>

<p>
  The exact dates of stations are not known. The Tropic article does describe
  the sequence (listed above), which at times varies from Neil’s recollection
  many years later.
</p>

<p>
  While in Michigan, Rogers broadcast football and basketball games for Albion
  College.
</p>
...
<p>
  According to the Miami Herald, Neil began his talk radio career at WSPB 1450
  in Sarasota, FL.
</p>

<blockquote>
  In 1973, Rogers moved to Sarasota, where quite by accident he did his first
  talk radio show. The station hired a retiree from Pittsburgh to do a talk
  show, but on his first day, the fellow couldn’t figure out to work the phone
  and his guest didn’t show up. The second day, the retiree’s blood pressure
  soared and his nose bled. Rogers, who was spinning records at the station,
  came to the rescue.
</blockquote>

<figure>
  <Image src="images/wspb-1450.jpg" alt="Neil Rogers at WSPB 1450" />
...
<p>
  ...
  started with WKAT. Neil was on from 3 pm – 6 pm. Prior to WKAT, Neil worked a
  few weekends on WIOD playing records (May 30, 1990, @55:28).
</p>

<figure>
  <Image src="images/neil-rogers-wkat.jpg" alt="Neil Rogers at WKAT" />
  <figcaption>Neil Rogers at WKAT</figcaption>
</figure>
<p>On December 17, 1976 Neil came out as gay on the air.</p>

<figure>
  <Image src="images/Neil-comes-out.jpg" alt="Neil Rogers Comes Out as Gay" />
  <figcaption>Source: Lakeland Ledger December 19, 1976</figcaption>
</figure>

<h3>Neil Rogers Nutrition (1977)</h3>

<p>Neil owned a health food store called Neil Rogers Nutrition in San Souci.</p>

<figure>
  <Image src="images/neil-rogers-nutrition-1.jpg" alt="Neil Rogers Nutrition" />
...
<p>
  Neil did play-by-play for Miami Hurricanes baseball (1978-1982 on radio and
  1983 on TV).
</p>

<figure>
  <Image
    src="images/neil-wnws-1981.jpg"
...
<p>
  On October 31, 1980, Neil left Miami and began broadcasting on WLAC 1510 in
  Nashville. After just one month he had enough and returned to WNWS.
</p>
...
<p>
  On March 1, 1984, Neil debuts on WINZ broadcasting from 8 PM to Midnight. On
  September 29, 1986, Neil moves his show to 10 AM – 2 PM.
</p>

<figure>
  <Image src="images/neil-1985.jpg" alt="94 News - Neil Rogers" />
...
<figure>
  <Image src="images/zeta-94-9.jpg" alt="Neil Rogers at Zeta 4" />
...
<p>
  Neil Rogers suffered a stroke on April 2, 1990 and was back on the air 3 weeks
  later.
</p>

<figure>
  <Image src="images/neil-rogers-wiod.jpg" alt="Neil Rogers at WIOD" />
  <figcaption>Neil Rogers at WIOD</figcaption>
</figure>
<p>
  On June 22, 1992 the WSUN Tampa Bay simulcast begins. On April 29, 1994, the
  WSUN simulcast of the Neil Rogers Show ended. (date not confirmed)
</p>

<figure>
  <Image
    src="images/neil-rogers-wsun-douchebag2.jpg"
    alt="WSUN Douchebag - Neil Rogers" />
  <figcaption>WSUN Douchebag - Neil Rogers</figcaption>
</figure>

<p>
  On December 20, 1996, the Internet stream of the Neil Rogers Show begins.
  (date not confirmed)
</p>
...
<p>
  After a 7 month radio hiatus, Neil Rogers joins WQAM. His debut show was on
  December 30, 1997.
</p>

<figure>
  <Image src="images/neil-rogers-wqam-560.jpg" alt="Neil Rogers at WQAM" />
...
<p>
  On December 24, 2010, Neil Rogers died at the Vitas Hospice at Florida Medical
  Center.
</p>
...
<figure>
  <Image
    src="images/neil-rogers-show.jpg"
...
<p>
  <em>
    Artwork by
    <a href="http://thepowwowshow.net/">Luis Amado</a>
  </em>
</p>
